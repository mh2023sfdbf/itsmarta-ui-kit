...
export default function FAQAccordion() {
  ...
  return (
    ...
    },
    {
      ...
      code: `export default function ThreeColumnFeatures() {
  const features = [
    {
      icon: (
      ...
      description: "Built for speed and performance. Get things done faster with streamlined workflows."
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Enterprise-grade security with 99.9% uptime. Your data is protected."
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Connect with your favorite tools seamlessly. Works right out of the box."
    }
  ];
    ...
    <section className="py-20 md:py-40 bg-white">
      <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="inline-flex items-center bg-white border border-gray-200 rounded-full shadow-sm p-1">
            <button 
              ...
              className={\`py-2 px-6 rounded-full text-sm transition duration-200 \${
                !isYearly ? 'bg-gray-900 text-white font-medium' : 'text-gray-500 hover:text-gray-700'
              }\`}
            >
              Monthly
            </button>
        ...
        <div className="grid gap-6 md:gap-8 lg:gap-10 md:grid-cols-3 max-w-6xl mx-auto">
          {/* Starter Plan */}
          <div className="rounded-2xl p-8 md:p-10 text-center bg-white flex flex-col shadow-md border border-gray-200">
          ...
          {/* Pro Plan */}
          <div className="rounded-2xl p-8 md:p-10 text-center bg-[#f7f6f4] flex flex-col shadow-lg border-2 border-gray-900 transform md:scale-105">
          ...
          {/* Enterprise Plan */}
          <div className="rounded-2xl p-8 md:p-10 text-center bg-white shadow-md flex flex-col border border-gray-200">
            <div className="bg-[#f7f6f4] rounded-full text-gray-900 font-medium py-1 px-4 text-xs mb-4 inline-block mx-auto border border-gray-200">
              For Organizations
            </div>
