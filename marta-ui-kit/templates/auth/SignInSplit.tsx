...
export default function SignInSplit() {
  ...
  return (
    ...
    >
      <div className="container px-4 mx-auto min-h-screen flex items-center justify-center md:justify-start py-8" suppressHydrationWarning>
        <div className="w-full md:w-3/5 lg:w-1/2 flex items-center justify-center">
