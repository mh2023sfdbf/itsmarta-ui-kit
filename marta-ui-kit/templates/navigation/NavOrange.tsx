        ...
        <div className="flex items-center justify-between py-5 relative">
          ...
          <div className="flex items-center">
            <a href="#" className="inline-block">
              <span className="font-sego text-2xl font-bold">YourLogo</span>
            </a>
          </div>
          ...
          <div className="hidden xl:flex items-center space-x-2">
            <a href="#" className="inline-flex py-3 px-6 text-lg font-medium text-black border border-gray-900 rounded-full transition duration-300 hover:bg-gradient-to-r hover:from-purple-200 hover:to-yellow-100">
              Sign In
            </a>
            <a href="#" className="inline-flex py-3 px-6 text-lg font-medium text-white bg-black border border-gray-900 rounded-full transition duration-300 hover:bg-gray-800">
              Register
            </a>
          </div>
          ...
          <nav className="relative z-10 bg-white h-full overflow-y-auto rounded-r-2xl shadow-xl">
            ...
            <div className="p-6">
              <ul className="space-y-4">
                <li>
                  <a href="#" className="block py-2 px-4 text-gray-800 hover:bg-purple-100 rounded-lg transition-colors duration-200 hover:text-black font-medium">
                    For journalers
                  </a>
                </li>
                <li>
              ...
              <div className="mt-8 space-y-3">
                <a href="#" className="block w-full py-3 px-4 text-center font-medium text-black border border-gray-900 rounded-full transition duration-300 hover:bg-purple-200">
                  Sign In
                </a>
